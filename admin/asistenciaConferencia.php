...
if (!($_SESSION['logged_in'])) {
    ...
    $data = $consultas->consultaAsistentesConferencia(base64_decode($_GET['id']));
}
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>CORE 2019 | Asistentes a conferencia</title>
    </head>
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2><i class="fa fa-slideshare"></i> &nbsp;<?= $_GET['nombre'] ?></h2>
                    </div>
                    <div class="col-lg-2 m-t-md">
                        <button class="btn btn-default btn-sm click-btn"><i class="fa fa-reply"></i> Volver a conferencias</button>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".click-btn").on("click", function () {
                    $(location).attr('href','conferencias.php');
                });
