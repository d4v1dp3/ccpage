...
<html>
    <head>
        ...
        <style>.minimal{color: #808080; font-weight: 600;}</style>
                                                ...
                                                if (isset($data) && $data != NULL) {
                                                    foreach ($data as $col) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="minimal"><i class="fa fa-calendar"></i> <?= $col['dia'] ?>&emsp;<i class="fa fa-clock-o"></i> <?= $col['hora'] ?> hrs.&emsp;<i class="fa fa-map-marker"></i> <?= $col['lugar'] ?></span><small><br><?= $col['descripcion'] ?></small></td>
