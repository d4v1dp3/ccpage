...
if (!($_SESSION['logged_in'])) {
    ...
    $data = $consultas->consultaAsistentesTaller(base64_decode($_GET['id']));
}
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>CORE 2019 | Asistentes a taller</title>
    </head>
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2><i class="fa fa-flask"></i> &nbsp;<?= $_GET['nombre'] ?></h2>
                    </div>
                    <div class="col-lg-2 m-t-md">
                        <button class="btn btn-default btn-sm click-btn"><i class="fa fa-reply"></i> Volver a los talleres</button>
                    </div>
                </div>
