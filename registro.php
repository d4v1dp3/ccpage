            ...
            <div>
                ...
                <form class="m-t" data-toggle="validator" role="form" method="post" action="classes/registrarUsuario.php">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control email-register-input" id="mailInput" name="email" maxlength="99" data-remote-error="Este correo ya fue registrado" data-remote="api/emailRegistro.php" placeholder="Correo" required="">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control email-register-input" id="mailInputConfirm" name="confirmEmail" data-match="#mailInput" data-match-error="El correo debe coincidir" maxlength="99" placeholder="Confirme correo" required="">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <p class="text-muted text-center"><small>¿Ya estás registrado?</small></p>
                    <a class="btn btn-sm btn-white register-btn" href="login.php">Iniciar sesión</a>
                    <a class="btn btn-sm btn-white register-btn m-t-sm" href="index.php">Ir a inicio</a>
                </form>
            </div>
        </div>
        <br>
